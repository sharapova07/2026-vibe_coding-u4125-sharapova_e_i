...
Фидбек от РП:  
```
Бот удобный, легко добавлять события и смотреть текущие мероприятия проектной команды. Особенно понравилось, что эти мероприятия разделены на дни и недели. Также было бы здорово, если при добавлении события можно было вернуться на предыдущий этап.
```
...
Внесение изменений:  
![(3) Внесение изменений](https://github.com/sharapova07/2026-vibe_coding-u4125-sharapova_e_i/blob/5cf093fe701d54d48a1bea8dec1e399f062aed83/lab3/screenshots3/(3-6).png)
Работающая кнопка `назад` в боте:  
![(3) Добавление кнопки назад](https://github.com/sharapova07/2026-vibe_coding-u4125-sharapova_e_i/blob/5cf093fe701d54d48a1bea8dec1e399f062aed83/lab3/screenshots3/(3-6).png)
